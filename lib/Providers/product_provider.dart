...
final productByIdProvider =
  ...
  final response =
      await dio.get("https://pucei.edu.ec:9101/api/v2/products/$id");
...
final createProductProvider =
  ...
  final response = await dio
      .post<Product>('https://pucei.edu.ec:9101/api/v2/products', data: {
    "name": product.name,
    "price": product.price,
    "stock": product.stock,
...
final deleteProductProvider =
  ...
  final response = await dio
      .delete<Product>('https://pucei.edu.ec:9101/api/v2/products/$id');
